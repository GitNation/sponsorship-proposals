export default {
  ...
  fields: [
    ...
    {
      name: 'featLogo1',
      title: 'Logo placed on the conference website, introduction/mid-session slides and throughout venue',
      type: 'string',
      fieldset: 'features',
    },
    {
    ...
    },
    {
      ...
      title: 'Sponsor announcement in social media channels (Twitter, Facebook, Medium',
      type: 'boolean',
      fieldset: 'features',
    },
    {
