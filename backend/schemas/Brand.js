export default {
  ...
  fields: [
    ...
    },
    {
      ...
      options: {
        list: [
          ...
          { title: 'JSNation', value: 'jsn' },
          { title: 'JSNation US', value: 'jsnus' },
          { title: 'React Summit', value: 'rs' },
          { title: 'React Summit US', value: 'rsus' },
          { title: 'React Advanced', value: 'radv' },
          { title: 'React Day Berline', value: 'rdb' },
          { title: 'Node Congress', value: 'node' },
          { title: 'JS GameDev', value: 'rdb' },
          { title: 'Vue Js', value: 'vjsl' },
    ...
    {
      title: 'Text Markdown first',
      name: 'aboutTextFirst',
      type: 'text',
      fieldset: 'about',
    },
    {
      title: 'Text Markdown second',
      name: 'aboutTextSecond',
      type: 'text',
      fieldset: 'about',
    },
    // decorations
